...
namespace Academy.HoloToolkit.Unity
{
    ...
    /// One that is for on-Holograms and another for off-Holograms.
    ...
    public class CursorManager : Singleton<CursorManager>
    {
        ...
        void Update()
        {
            ...
            if (GazeManager.Instance == null
                ...
                || CursorOffHolograms == null)
            {
                return;
            }

            // change cursors depending on whether gaze falls on a hologram or not
            ...
            // 2.b: Assign active(?) gameObject's transform position equals GazeManager's instance Position.
            gameObject.transform.position = GazeManager.Instance.Position;

            // 2.b: Assign active(?) gameObject's transform up-vector equals GazeManager's instance Normal.
            // Allows the active cursor to lie flat/face-up on the surface of a hit hologram
